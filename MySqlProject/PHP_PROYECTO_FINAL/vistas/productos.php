...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <form action="../actions/actionsProductos/agregarProducto.php" method="post">
    <div>
    ...
    <div class="mb-3">
      <label for="ubicacion_bodega" class="form-label">Ubicación en bodega:</label>
      <input type="text" class="form-control" id="ubicacion_bodega" name="ubicacion_bodega" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control" id="cantidad_actual" name="cantidad_actual" min="0" required>
    </div>
    <div class="mb-3">
      <label for="codigo_restaurante" class="form-label">Código del restaurante:</label>
      <input type="number" class="form-control" id="codigo_restaurante" name="codigo_restaurante" min="1" required>
    </div>
...
<div class="container mt-5">
  <form action="../actions/actionsProductos/actualizarProducto.php" method="post">
    <div>
  ...
  <input type="number" class="form-control" id="codigo_inventario" name="codigo_inventario" min="1" required>
</div>
<div class="mb-3">
  <label for="nombre_producto" class="form-label">Nombre del producto:</label>
  <input type="text" class="form-control" id="nombre_producto" name="nombre_producto" required>
...
<div class="container mt-5">
  <form action="../actions/actionsProductos/eliminarProducto.php" method="post">
    <div>
      <h1 class="text-center mb-4">Eliminar producto</h1>
    </div>
    <div class="mb-3">
      <label for="codigo_producto" class="form-label">Código del producto:</label>
      <input type="number" class="form-control" id="codigo_producto" name="codigo_producto" min="1" required>
    </div>
    <div class="mb-3">
      <label for="nombre_producto" class="form-label">Nombre del producto:</label>
      <input type="text" class="form-control" id="nombre_producto" name="nombre_producto" readonly>
    </div>
    <button type="submit" class="btn btn-danger" name="eliminar_producto">Eliminar producto</button>
  </form>
</div>
