...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <form action="../actions/actionsAcompañantesplato/agregarAcompañantesplato.php" method="post">
    <div>
    <h1 class="text-center mb-4">Agregar nuevo acompañante plato</h1>
    </div>

    <div class="mb-3">
      <label for="codigo_acompanante" class="form-label">Codigo del acompañante del plato:</label>
      <input type="number" class="form-control" id="codigo_acompanante" name="codigo_acompanante" required>
    </div>

    <div class="mb-3">
      <label for="codigo_plato" class="form-label">Codigo del plato:</label>
      <input type="number" class="form-control" id="codigo_plato" name="codigo_plato" required>
    </div>
     
    <button type="submit" class="btn btn-primary">Agregar Acompañante del Plato</button>
  </form>
</div>
