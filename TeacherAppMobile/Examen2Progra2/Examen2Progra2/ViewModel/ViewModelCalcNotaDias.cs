...
namespace Examen2Progra2.ViewModel
{
    public class ViewModelCalcNotaDias : BaseViewModel
    {
        ...
        #region VARIABLES
        private AlumnoDiasDeSemana alumno = new AlumnoDiasDeSemana();
        ...
        #region CONSTRUCTOR
        public ViewModelCalcNotaDias(INavigation navigation, Alumno alumnoActual)
        {
        ...
        public async Task GuardarNotas()
        {
            ...
            DisplayAlert("", $"Notas Almacenadas Exitosamente", "Aceptar");
        }
